...
export default function StepBasicInfo({ onNext }: Props) {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      {/* 왼쪽: 설명 */}
      <div className="border-b md:border-b-0 md:border-r border-black px-6 md:px-10 py-10 md:py-14 flex flex-col justify-between md:w-[40%]">
        <div>
          <p className="text-xs tracking-[0.3em] uppercase text-neutral-400 mb-8">Step 01 — 기본 정보</p>
      ...
      <div className="flex-1 px-6 md:px-10 py-10 md:py-14 flex flex-col justify-center gap-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="홍길동"
            className="w-full border border-neutral-200 px-4 py-3 text-sm outline-none focus:border-black transition-colors placeholder:text-neutral-300"
          />
        </div>
        ...
        <div>
          <label className="block text-xs tracking-[0.2em] uppercase text-neutral-400 mb-2">
            희망 직종 <span className="text-black">*</span>
          </label>
          <input
            type="text"
            value={targetJob}
