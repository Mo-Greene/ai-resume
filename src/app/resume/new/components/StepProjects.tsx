...
- 성과를 물을 때는 반드시 수치(%, 사용자 수, 속도 개선, 금액 등)를 함께 묻어 구체화하세요.
...
작성 원칙:
- 성과는 수치(%, 사용자 수, 응답 속도 개선, 금액 등)를 포함해 구체적으로 작성하세요.
- 문장은 "주도했다", "구현했다", "개선했다", "달성했다" 등 능동 동사로 시작하세요.
- 역할 나열이 아닌 기여도와 임팩트 중심으로 서술하세요.
