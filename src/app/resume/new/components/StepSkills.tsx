  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="md:w-[40%] border-b md:border-b-0 md:border-r border-foreground px-6 md:px-10 py-10 md:py-14 flex flex-col justify-between">
        <div>
          <p className="text-xs tracking-[0.3em] uppercase text-muted-foreground mb-8">Step 04 — 스킬 & 기타</p>
      ...
      <div className="flex-1 px-6 md:px-10 py-10 md:py-14 flex flex-col justify-center gap-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full border border-border px-4 py-3 text-sm outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground/40 resize-none leading-relaxed bg-background text-foreground"
          />
        </div>
